...
#config_file = "/home/cissa/Generate-Partitions-Random3/R3-Config-Files/R3-GpositiveGO.csv"
...
cat("\n####################################################################")
cat("\n# Execute RANDOM 3 Partitions                                      #")
cat("\n####################################################################\n\n")
timeFinal <- system.time(results <- executeGPR3(ds,
                                               dataset_name,
                                               number_dataset, 
                                               number_cores, 
                                               number_folds, 
...
# cat("\n####################################################################\n\n")
# destino = paste("nuvem:Partitions-Random3/", dataset_name, sep="")
...
str_a <- paste("tar -zcf ", diretorios$folderResults, "/", dataset_name, 
               "-results-gpr3.tar.gz ",  diretorios$folderReports, sep = "")
print(system(str_a))
...
str_b <- paste("cp -r ", diretorios$folderResults, "/", dataset_name, 
               "-results-gpr3.tar.gz ", folder, sep = "")
print(system(str_b))
