...
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/R3-Ma-Branco.png" width="300">

# Random Partitions Version 3 with Micro-F1
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/R3-Mi-Branco.png" width="300">

# Random Partitions Version 3 with Silhouete
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/R3-S-Branco.png" width="300">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/10-Folds-Cross-Validation.png" width="300">

### Step-2
Place a copy of this code in _"C:/Users/[username]/Generate-Partitions-Random3"_ or _"/home/username/Generate-Partitions-Random3_. Our files are configured to obtain the paths of the folders from the root. You can change this in the code if you want.
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/Folder-Structure-R3.png" width="300">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random3/blob/main/images/Output-R3.png" width="300">

## RUN
To run the code, open the terminal, enter */home/[username]/Generate-Partitions-Random3/scripts/* folder, and type:

```
Rscript random3.R [number_dataset] [number_cores] [number_folds] [name_folder_results]
```
...
```
Rscript random3.R 17 5 10 "/dev/shm/results/"
```
